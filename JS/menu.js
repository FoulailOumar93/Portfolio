  ...
  <header>
    ...
    <nav>
      <ul>
        ...
        <li><a href="../HTML/Stage.html" data-i18n="menu_stage">Stages</a></li>
        <li><a href="../HTML/Veille Technologique.html" data-i18n="menu_veille">Veille Techno</a></li>
      ...
      <div class="lang-switch">
        ...
        <button class="lang-btn" data-lang="ta">🇮🇳</button>
      </div>
    </nav>
  </header>
`;
